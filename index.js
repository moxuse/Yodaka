...
(function($PS) {
  ...
  var indexOfUniform = Graphics_Three_Util.ffi([ "material", "name", "" ])("Object.keys(material.uniforms).indexOf(name);");
  exports["updateMaterial"] = updateMaterial;
  exports["indexOfUniform"] = indexOfUniform;
})(PS);
(function(exports) {
  /* global exports */
  "use strict";
...
(function($PS) {
  ...
  var validateUniform = function (dictRenderable) {
      return function (target) {
          return function (name) {
              return function (onValid) {
                  return function __do() {
                      var v = Graphics_Three_Object3D.getMaterial()()(target)();
                      var v1 = Graphics_Three_MaterialAddition.indexOfUniform(v)(name)();
                      var $17 = v1 < 0;
                      if ($17) {
                          return Effect_Exception.throwException(Effect_Exception.error("Unknown Uniform : " + name))();
                      };
                      var v2 = onValid();
                      return target;
                  };
  ...
  var setUniformByOsc = function (dictRenderable) {
      return function (addr) {
          return function (name) {
              return function (target) {
                  var onValid = Graphics_Yodaka_IO_Osc.addListener(addr)(function (msg) {
                      return setUniform()(name)(msg)(target)();
                  });
                  return validateUniform()(target)(name)(onValid);
              };
          };
      };
  };
  var applyOperator = function (dictFunctor) {
      return function (x) {
          return function (y) {
              return Data_Functor.map(dictFunctor)(y)(x);
          };
      };
  };
...
(function($PS) {
  ...
  var main = function __do() {
      ...
      return Control_Bind.bindFlipped(Effect.bindEffect)(Graphics_Yodaka_Context.add())(Graphics_Yodaka_IO_Operator.applyOperator(Effect.functorEffect)(Graphics_Yodaka_Renderable_Plane_Shader.noisePlane)(Graphics_Yodaka_Context.uOsc()("/x")("density")))();
  };
  exports["main"] = main;
})(PS);
PS["Main"].main();