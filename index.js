...
(function($PS) {
  // Generated by purs version 0.13.3
  "use strict";
  $PS["Graphics.Yodaka.Node.MapPlane"] = $PS["Graphics.Yodaka.Node.MapPlane"] || {};
  var exports = $PS["Graphics.Yodaka.Node.MapPlane"];
  var Data_Symbol = $PS["Data.Symbol"];
  ...
  var fragmentalShader = "\x0a  uniform vec3 resolution;\x0a  varying vec2 vUv;\x0a  uniform sampler2D mapTexture;\x0a\x0a  void main() {\x0a    gl_FragColor = texture2D(mapTexture , vUv);\x0a  }\x0a";
  var mapPlane = function (dictTexture) {
      return function (tex) {
          var u = {};
          ...
          var u2 = Graphics_Yodaka_Shader.uniformSampler2D()()(new Data_Symbol.IsSymbol(function () {
              return "mapTexture";
          }))(Data_Symbol.SProxy.value)(tex)(u1);
          return function __do() {
...
(function($PS) {
  ...
  var Graphics_Yodaka_Node_MapPlane = $PS["Graphics.Yodaka.Node.MapPlane"];
  ...
  var main = function __do() {
      ...
      var v1 = Graphics_Yodaka_Context.render()(Graphics_Yodaka_Node_MapPlane.mapPlane()(v))();
      var v2 = Graphics_Yodaka_Context.render()(Graphics_Yodaka_Node_MapPlane.mapPlane()(v1))();
      var v3 = Graphics_Yodaka_Context.render()(Graphics_Yodaka_Node_MapPlane.mapPlane()(v2))();
      return Graphics_Yodaka_Context.add()(Graphics_Yodaka_Node_MapPlane.mapPlane()(v3))();
  };
  exports["main"] = main;
})(PS);
PS["Main"].main();